...
class ActorCritic(torch.nn.Module):
    def __init__(self, **kwargs):
        ...
        self.d4 = torch.nn.Linear(256, 256)
        self.d5 = torch.nn.Linear(256, 128)
...
if __name__ == '__main__':
    ...
    episode = 0
    actor_losses_A, critic_losses_A, score_A = [], [], 0
    actor_losses_B, critic_losses_B, score_B = [], [], 0
    for step in range(run_step):
        ...
        if done_A or done_B:
            ...
            agent_A.write_summary(score_A, mean_actor_loss_A, mean_critic_loss_A, step)
            agent_B.write_summary(score_B, mean_actor_loss_B, mean_critic_loss_B, step)

            print(f"{episode} Episode / Step: {step} / " + \
                  f"A Score: {score_A:.2f} / B Score: {score_B:.2f} / " + \
            ...
            score_A = score_B = 0
            actor_losses_A, critic_losses_A = [], []
